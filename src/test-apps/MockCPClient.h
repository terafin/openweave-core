...
public:
    ...
    /* WEAVE_ERROR Init(WeaveExchangeManager *exchangeMgr, uint8_t reqType, EncodeReqAuthInfoFunct encodeReqAuthInfo, HandleCertificateProvisioningResultFunct onCertProvDone); */
